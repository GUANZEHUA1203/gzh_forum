                ...
                formatter : function(value, row, index) {
                    var str = '';
                        <shiro:hasPermission name="/account/update">
                            str += $.formatString('<a href="javascript:void(0)" class="user-easyui-linkbutton-edit" data-options="plain:true,iconCls:\'glyphicon-pencil icon-blue\'" onclick="editUserFun(\'{0}\');" >编辑</a>', row.acid);
                        </shiro:hasPermission>
                        <shiro:hasPermission name="/account/del">
                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
                            str += $.formatString('<a href="javascript:void(0)" class="user-easyui-linkbutton-del" data-options="plain:true,iconCls:\'glyphicon-trash icon-red\'" onclick="deleteUserFun(\'{0}\');" >删除</a>', row.acid);
                        </shiro:hasPermission>
                    return str;
                }
            }] ],
